...
function postnew() {
    ...
    $.ajax({
        ...
        //url : "https://dashiacosmosdatawriter.azurewebsites.net/api/dashiacosmosdatawriter",
...
function createList(which, city) {
    ...
    // run in cloud
    $.get("https://dashiacosmosdatawriter.azurewebsites.net/api/dashiacosmosdatawriter/?name="+ param, function(data, status){
